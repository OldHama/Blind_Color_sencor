...
void loop() {
  ...
  Serial.println("Dominant color: " +
   ...
   if (color_indices[tcs3200.get_rgb_dominant_color()] == "Red"){
    tmrpcm.play("Red.wav");
    delay(2000);
   }
   else if (color_indices[tcs3200.get_rgb_dominant_color()] == "Green"){
    tmrpcm.play("Green.wav");
    delay(2000);
   }
   else if (color_indices[tcs3200.get_rgb_dominant_color()] == "Blue"){
